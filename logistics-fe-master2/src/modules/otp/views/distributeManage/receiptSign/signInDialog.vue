        ...
        <div class="signContent">
            ...
            <div class="receiveRight">
                ...
                <el-table :data="tableData" border tooltip-effect="dark" height="260">
                    ...
                    <el-table-column :show-overflow-tooltip='true' label="正品" width='90' align='center'>
                    ...
                    <el-table-column :show-overflow-tooltip='true' label="污染" width='90' align='center'>
                        <template slot-scope="scope">
                            <div>
                    ...
                    <el-table-column :show-overflow-tooltip='true' label="破损" width='90' align='center'>
                        <template slot-scope="scope">
                            <div>
                    ...
                    <el-table-column :show-overflow-tooltip='true' label="短少" width='90' align='center'>
                        <template slot-scope="scope">
                            <div>
                    ...
                    <el-table-column :show-overflow-tooltip='true' label="拒收" width='90' align='center'>
                        <template slot-scope="scope">
                            <div>
...
import { receiptDetail, receiptSign, receiptRejectsign, receiptUpload, receiptDeleteReceiptpicture } from '../../../api/receiptSign';

export default {
    components: { rejectDialog, upload, b2cRejectDialog },
    props: {
        signInShow: {
            type: Boolean,
            default() {
    ...
    methods: {
        ...
        edit(obj, property) {
            ...
            if (this.rowData.businessMode === 'B2C') {
                if (this.totalData.sourceSystem === 'CCS') {
                    obj.show = true;
                }
                if (this.totalData.sourceSystem === 'CVTE') {
                    obj.show = true;
                }
                return false;
            }
            ...
            receiptDetail(this.rowData.taskNo).then(res => {
                if (res) {
                    res.data.itemDetails.forEach(item => {
                        this.tableData.push({
                            sourceSystem: res.data.sourceSystem,
                            lineNo: item.lineNo,
