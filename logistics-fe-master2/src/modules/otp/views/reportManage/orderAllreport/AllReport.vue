        ...
        <list-layout-paper>
            ...
            <div slot="list" slot-scope="props">
                <el-table border :data="userData" :height="props.tableHeight" :header-cell-style="tableHeaderColor" v-loading="loading">
                    ...
                    <el-table-column prop="anntoOrderNo" label="安得订单号" width="150"></el-table-column>
                    ...
                    <el-table-column prop="executeStatus" label="订单执行状态" width="100"></el-table-column>
...
import { getAllReportList, exportAllReportList, getSystemList } from './orderApi.js';
import listLayoutPaper from '@/components/lots/listLayout/Paper';
import options from './optionApi.js';
    ...
    data() {
        return {
            ...
            searchTotalTitle: [{
                ...
                type: 'advance',
                select: true,
                options: options.customerWhCode
            }, {
                name: '客户订名称',
                value: 'customerName',
                type: 'input',
