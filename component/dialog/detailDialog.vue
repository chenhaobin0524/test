...
export default {
    ...
    methods: {
        ...
        rowDrop() {
            this.$nextTick(() => {
                const dispatchNo = this.$route.query.dispatchNo;
        ...
        detailShowOk() {
            ...
            var params = { loadList: this.tableDataLists, unLoadList: this.tableLitsDatas, dispatchNo: this.$route.query.dispatchNo, sysFlag: this.sysFlag };
        ...
        // 页面加载接口优化
        loadDialog() {
            getOptimizationDialogLists(this.$route.query.dispatchNo).then(res => {
        ...
        bestPath() {
            this.isLoading = true;
            getOptimalPathComputation(this.$route.query.dispatchNo).then(res => {
                if (res && res.code === '0') {
                    this.totalMileage = res.data.totalMileage;
                    this.loadSubsidyMileage = res.data.loadSubsidyMileage;
                    this.unloadSubsidyMileage = res.data.unloadSubsidyMileage;
